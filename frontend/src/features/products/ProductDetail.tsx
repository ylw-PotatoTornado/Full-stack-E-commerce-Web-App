import { Form, Link, redirect, useActionData, useLoaderData, useLocation, useRouteLoaderData } from "react-router-dom";
...
export function ProductDetail() {
  ...
  //find image path using Id
  const imagePath = getProductImagePath(productData.id);
