  ...
  return (
    <div className={utilStyles.pagePadding}>
      ...
      <section className={utilStyles.mb3rem}>
        <h2 className={styles.highlightBackground}>Key details</h2>
      ...
      <section className={utilStyles.mb3rem}>
        <h2 className={styles.highlightBackground}>Items</h2>
        {renderOrderItems(order_items, false)}
      </section>
      <section className={utilStyles.mb3rem}>
        <h2 className={`${utilStyles.mb2rem} ${styles.highlightBackground}`}>Delivery address</h2>
        <p>{address}</p>
        <p>{postcode}</p>
      </section>
